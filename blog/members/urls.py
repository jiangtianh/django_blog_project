...
from .views import UserRegisterView, UserEditView, CustomPasswordChangeView, password_success, ShowProfilePageView, EditProfilePageView, CreateProfilePageView
